...
- [ ] Alineada con arquitectura y stack (Java Spring Boot + JPA/Hibernate + PostgreSQL + RabbitMQ)
...
2. Lee las instrucciones de stack: `.opencode/instructions/backend.instructions.md`

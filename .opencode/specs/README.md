...
```
.opencode/specs/<nombre-feature-en-kebab-case>.spec.md
```
...
Los siguientes requerimientos están en `.opencode/requirements/` listos para convertirse en spec:

| Requerimiento | Archivo | Acción |
|---------------|---------|--------|
| Creación de Usuarios | `.opencode/requirements/user-creation.md` | `/generate-spec user-creation` |
...
Ver `.opencode/skills/generate-spec/spec-template.md`
